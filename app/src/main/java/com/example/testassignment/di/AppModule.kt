    ...
    single {
        ...
        httpClient.addInterceptor { chain ->
            ...
            val accessToken: String = when {
                // Hawk.contains(ACCESS_TOKEN) -> Hawk.get(ACCESS_TOKEN)
                Hawk.contains(ACCESS_TOKEN) -> Hawk.get(ACCESS_TOKEN)
                //uncomment it if anything goes beyond your understanding.
              //  Hawk.contains(TEMP_TOKEN) -> "Bearer ".plus(Hawk.get<String>(TEMP_TOKEN))
                else -> ""
            }
